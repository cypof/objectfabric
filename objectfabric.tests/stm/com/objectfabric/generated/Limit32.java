...
public class Limit32 extends com.objectfabric.TGeneratedFields32 {

    public Limit32() {
        this(com.objectfabric.Transaction.getDefaultTrunk());
    }

    public Limit32(com.objectfabric.Transaction trunk) {
        this(new Version(null, FIELD_COUNT), trunk);
    }

    protected Limit32(com.objectfabric.TObject.Version shared, com.objectfabric.Transaction trunk) {
        super(shared, trunk);
    }

    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(com.objectfabric.generated.LimitsObjectModel.getInstance(), com.objectfabric.generated.LimitsObjectModel.COM_OBJECTFABRIC_GENERATED_LIMIT32_CLASS_ID);
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public com.objectfabric.TObject.Version merge(com.objectfabric.TObject.Version target, com.objectfabric.TObject.Version next, int flags) {
            Limit32.Version source = (Limit32.Version) next;
            Limit32.Version merged = (Limit32.Version) super.merge(target, next, flags);
        ...
        public com.objectfabric.TObject.Version createVersion() {
            return new Limit32.Version(this, FIELD_COUNT);
        }

        @Override
        public int getClassId() {
            return com.objectfabric.generated.LimitsObjectModel.COM_OBJECTFABRIC_GENERATED_LIMIT32_CLASS_ID;
        }
