...
public class MultiplexerTest extends TestsHelper {
    ...
    private void transfer() {
        ...
        int length = com.objectfabric.misc.PlatformAdapter.getRandomInt(10000);
    ...
    public static void main(String[] args) throws Exception {
        MultiplexerTest test = new MultiplexerTest();
        ...
        public byte read() {
            ...
            for (;;) {
                ...
                switch (step) {
                    ...
                    case OBJECT: {
                        Object o = UnknownObjectSerializer.read(this, code);
