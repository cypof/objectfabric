...
public class TArrayString extends TIndexed implements Iterable<java.lang.String> {
    ...
    static {
        TYPE = Platform.newTType(Platform.get().defaultObjectModel(), -1, Immutable.STRING.type());
    }
    ...
    public TArrayString(Resource resource, int length) {
        super(resource, new TArrayVersionString(length));

        _length = length;
        _genericParameters = new TType[] { Immutable.STRING.type() };
    }
     ...
     */
    /* generic start public TArrayString(Resource resource, int length, TType genericParam) {
        super(resource, new TArrayVersionString(length));

        _length = length;

        TType[] value = new TType[] { Immutable.STRING.type() };
    ...
    public final java.lang.String get(int index) {
        ...
        TArrayVersionString version = (TArrayVersionString) getVersionN_(inner, index);
        java.lang.String value = version != null ? (java.lang.String) version.get(index) : null;
    ...
    public final void set(int index, java.lang.String value) {
        ...
        TArrayVersionString version = (TArrayVersionString) getOrCreateVersion_(inner);
    ...
    protected final TObject.Version createVersion_() {
        TArrayVersionString version = new TArrayVersionString(0);
