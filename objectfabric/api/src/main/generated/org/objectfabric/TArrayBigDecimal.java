...
public class TArrayBigDecimal extends TIndexed implements Iterable<java.math.BigDecimal> {
    ...
    static {
        TYPE = Platform.newTType(Platform.get().defaultObjectModel(), -1, Immutable.DECIMAL.type());
    }
    ...
    public TArrayBigDecimal(Resource resource, int length) {
        super(resource, new TArrayVersionBigDecimal(length));

        _length = length;
        _genericParameters = new TType[] { Immutable.DECIMAL.type() };
    }
     ...
     */
    /* generic start public TArrayBigDecimal(Resource resource, int length, TType genericParam) {
        super(resource, new TArrayVersionBigDecimal(length));

        _length = length;

        TType[] value = new TType[] { Immutable.DECIMAL.type() };
    ...
    public final java.math.BigDecimal get(int index) {
        ...
        TArrayVersionBigDecimal version = (TArrayVersionBigDecimal) getVersionN_(inner, index);
        java.math.BigDecimal value = version != null ? (java.math.BigDecimal) version.get(index) : null;
    ...
    public final void set(int index, java.math.BigDecimal value) {
        ...
        TArrayVersionBigDecimal version = (TArrayVersionBigDecimal) getOrCreateVersion_(inner);
    ...
    protected final TObject.Version createVersion_() {
        TArrayVersionBigDecimal version = new TArrayVersionBigDecimal(0);
