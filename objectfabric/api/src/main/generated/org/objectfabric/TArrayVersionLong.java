...
class TArrayVersionLong extends TIndexed.VersionN {
    ...
    final void setValues(long[][] value) {
        _values = value;
    }
    ...
    TObject.Version merge(TObject.Version target, TObject.Version next, boolean threadPrivate) {
        ...
        TArrayVersionLong merged = (TArrayVersionLong) super.merge(target, next, threadPrivate);
    ...
    void deepCopy(TObject.Version source_) {
        TArrayVersionLong source = (TArrayVersionLong) source_;
    ...
    // TODO simplify
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionLong source, boolean deep) {
                ...
                if (deep) {
                    ...
                    for (int i = _values.length - 1; i >= 0; i--) {
                        if (source._values[i] != null) {
                            ...
                            _values[i] = new long[arrayLength];
    ...
    private static void merge(long[] merged, org.objectfabric.Bits.Entry writes, long[] source) {
    ...
    public final void readWrite(Reader reader, int index, java.lang.Object[] versions) {
        ...
        for (int i = versions.length - 1; i >= 0; i--)
            ((TArrayVersionLong) versions[i]).set(index, value);
    }
