...
class TArrayVersionDouble extends TIndexed.VersionN {

    // .NETstatic readonly bool IS_TOBJECT = ObjectFabric.TType.IsTObject(typeof(T));

    private double[][] _values;

    TArrayVersionDouble(int length) {
        super(length);
    ...
    final void setValues(double[][] value) {
        _values = value;
    }
    ...
    TObject.Version merge(TObject.Version target, TObject.Version next, boolean threadPrivate) {
        ...
        TArrayVersionDouble merged = (TArrayVersionDouble) super.merge(target, next, threadPrivate);
    ...
    void deepCopy(TObject.Version source_) {
        TArrayVersionDouble source = (TArrayVersionDouble) source_;
    ...
    // TODO simplify
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionDouble source, boolean deep) {
                ...
                if (deep) {
                    ...
                    for (int i = _values.length - 1; i >= 0; i--) {
                        if (source._values[i] != null) {
                            ...
                            _values[i] = new double[arrayLength];
    ...
    private static void merge(double[] merged, org.objectfabric.Bits.Entry writes, double[] source) {
    ...
    public final void readWrite(Reader reader, int index, java.lang.Object[] versions) {
        ...
        for (int i = versions.length - 1; i >= 0; i--)
            ((TArrayVersionDouble) versions[i]).set(index, value);
    }
