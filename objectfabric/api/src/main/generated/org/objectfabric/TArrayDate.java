...
public class TArrayDate extends TIndexed implements Iterable<java.util.Date> {
    ...
    static {
        TYPE = Platform.newTType(Platform.get().defaultObjectModel(), -1, Immutable.DATE.type());
    }
    ...
    public TArrayDate(Resource resource, int length) {
        super(resource, new TArrayVersionDate(length));

        _length = length;
        _genericParameters = new TType[] { Immutable.DATE.type() };
    }
     ...
     */
    /* generic start public TArrayDate(Resource resource, int length, TType genericParam) {
        super(resource, new TArrayVersionDate(length));

        _length = length;

        TType[] value = new TType[] { Immutable.DATE.type() };
    ...
    public final java.util.Date get(int index) {
        ...
        TArrayVersionDate version = (TArrayVersionDate) getVersionN_(inner, index);
        java.util.Date value = version != null ? (java.util.Date) version.get(index) : null;
    ...
    public final void set(int index, java.util.Date value) {
        ...
        TArrayVersionDate version = (TArrayVersionDate) getOrCreateVersion_(inner);
    ...
    protected final TObject.Version createVersion_() {
        TArrayVersionDate version = new TArrayVersionDate(0);
