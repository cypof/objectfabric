...
class TArrayVersionString extends TIndexed.VersionN {
    ...
    final java.lang.String[][] getValues() {
        return _values;
    }

    final void setValues(java.lang.String[][] value) {
        _values = value;
    }
    ...
    TObject.Version merge(TObject.Version target, TObject.Version next, boolean threadPrivate) {
        ...
        TArrayVersionString merged = (TArrayVersionString) super.merge(target, next, threadPrivate);
    ...
    void deepCopy(TObject.Version source_) {
        TArrayVersionString source = (TArrayVersionString) source_;
    ...
    // TODO simplify
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionString source, boolean deep) {
                ...
                if (deep) {
                    ...
                    for (int i = _values.length - 1; i >= 0; i--) {
                        if (source._values[i] != null) {
                            ...
                            _values[i] = new java.lang.String[arrayLength];
    ...
    private static void merge(java.lang.String[] merged, org.objectfabric.Bits.Entry writes, java.lang.String[] source) {
    ...
    public final void readWrite(Reader reader, int index, java.lang.Object[] versions) {
        ...
        for (int i = versions.length - 1; i >= 0; i--)
            ((TArrayVersionString) versions[i]).set(index, value);
    }
