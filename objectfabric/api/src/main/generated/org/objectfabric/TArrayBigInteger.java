...
public class TArrayBigInteger extends TIndexed implements Iterable<java.math.BigInteger> {
    ...
    static {
        TYPE = Platform.newTType(Platform.get().defaultObjectModel(), -1, Immutable.BIG_INTEGER.type());
    }
    ...
    public TArrayBigInteger(Resource resource, int length) {
        super(resource, new TArrayVersionBigInteger(length));

        _length = length;
        _genericParameters = new TType[] { Immutable.BIG_INTEGER.type() };
    }
     ...
     */
    /* generic start public TArrayBigInteger(Resource resource, int length, TType genericParam) {
        super(resource, new TArrayVersionBigInteger(length));

        _length = length;

        TType[] value = new TType[] { Immutable.BIG_INTEGER.type() };
    ...
    public final java.math.BigInteger get(int index) {
        ...
        TArrayVersionBigInteger version = (TArrayVersionBigInteger) getVersionN_(inner, index);
        java.math.BigInteger value = version != null ? (java.math.BigInteger) version.get(index) : null;
    ...
    public final void set(int index, java.math.BigInteger value) {
        ...
        TArrayVersionBigInteger version = (TArrayVersionBigInteger) getOrCreateVersion_(inner);
    ...
    protected final TObject.Version createVersion_() {
        TArrayVersionBigInteger version = new TArrayVersionBigInteger(0);
