...
public class TArrayDouble extends TIndexed implements Iterable<Double> {
    ...
    static {
        TYPE = Platform.newTType(Platform.get().defaultObjectModel(), -1, Immutable.DOUBLE.type());
    }
    ...
    public TArrayDouble(Resource resource, int length) {
        super(resource, new TArrayVersionDouble(length));

        _length = length;
        _genericParameters = new TType[] { Immutable.DOUBLE.type() };
    }
     ...
     */
    /* generic start public TArrayDouble(Resource resource, int length, TType genericParam) {
        super(resource, new TArrayVersionDouble(length));

        _length = length;

        TType[] value = new TType[] { Immutable.DOUBLE.type() };
    ...
    public final double get(int index) {
        ...
        TArrayVersionDouble version = (TArrayVersionDouble) getVersionN_(inner, index);
        double value = version != null ? (double) version.get(index) : 0;
    ...
    public final void set(int index, double value) {
        ...
        TArrayVersionDouble version = (TArrayVersionDouble) getOrCreateVersion_(inner);
    ...
    protected final TObject.Version createVersion_() {
        TArrayVersionDouble version = new TArrayVersionDouble(0);
