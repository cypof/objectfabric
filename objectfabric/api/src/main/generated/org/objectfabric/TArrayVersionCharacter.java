...
class TArrayVersionCharacter extends TIndexed.VersionN {

    // .NETstatic readonly bool IS_TOBJECT = ObjectFabric.TType.IsTObject(typeof(T));

    private char[][] _values;

    TArrayVersionCharacter(int length) {
        super(length);
    ...
    final char[][] getValues() {
        return _values;
    }

    final void setValues(char[][] value) {
        _values = value;
    }
    ...
    TObject.Version merge(TObject.Version target, TObject.Version next, boolean threadPrivate) {
        ...
        TArrayVersionCharacter merged = (TArrayVersionCharacter) super.merge(target, next, threadPrivate);
    ...
    void deepCopy(TObject.Version source_) {
        TArrayVersionCharacter source = (TArrayVersionCharacter) source_;
    ...
    // TODO simplify
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionCharacter source, boolean deep) {
                ...
                if (deep) {
                    ...
                    for (int i = _values.length - 1; i >= 0; i--) {
                        if (source._values[i] != null) {
                            ...
                            _values[i] = new char[arrayLength];
    ...
    private static void merge(char[] merged, org.objectfabric.Bits.Entry writes, char[] source) {
    ...
    public final void readWrite(Reader reader, int index, java.lang.Object[] versions) {
        ...
        for (int i = versions.length - 1; i >= 0; i--)
            ((TArrayVersionCharacter) versions[i]).set(index, value);
    }
