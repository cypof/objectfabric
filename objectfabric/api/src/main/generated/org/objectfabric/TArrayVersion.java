...
class TArrayVersion extends TIndexed.VersionN {
    ...
    final void setValues(Object[][] value) {
        _values = value;
    }
    ...
    TObject.Version merge(TObject.Version target, TObject.Version next, boolean threadPrivate) {
        ...
        TArrayVersion merged = (TArrayVersion) super.merge(target, next, threadPrivate);
    ...
    void deepCopy(TObject.Version source_) {
        TArrayVersion source = (TArrayVersion) source_;
    ...
    // TODO simplify
    @SuppressWarnings("cast")
    private final void merge(TArrayVersion source, boolean deep) {
                ...
                if (deep) {
                    ...
                    for (int i = _values.length - 1; i >= 0; i--) {
                        if (source._values[i] != null) {
                            ...
                            _values[i] = new Object[arrayLength];
    ...
    private static void merge(Object[] merged, org.objectfabric.Bits.Entry writes, Object[] source) {
    ...
    public final void readWrite(Reader reader, int index, java.lang.Object[] versions) {
        ...
        for (int i = versions.length - 1; i >= 0; i--) {
            ...
            ((TArrayVersion) versions[i]).set(index, value);
        }
    }
