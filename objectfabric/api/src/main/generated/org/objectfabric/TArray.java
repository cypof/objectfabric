...
public class TArray<E> extends TIndexed implements Iterable<E>  {
    ...
    static {
        TYPE = Platform.newTType(Platform.get().defaultObjectModel(), -1);
    }
    ...
    public TArray(Resource resource, int length) {
        super(resource, new TArrayVersion(length));
     ...
     */
    /* generic start public TArray(Resource resource, int length, TType genericParam) {
        super(resource, new TArrayVersion(length));
    ...
    public final E get(int index) {
        ...
        TArrayVersion version = (TArrayVersion) getVersionN_(inner, index);
        Object value = version != null ? (Object) version.get(index) : null;
    ...
    public final void set(int index, E value) {
        ...
        TArrayVersion version = (TArrayVersion) getOrCreateVersion_(inner);
    ...
    protected final TObject.Version createVersion_() {
        TArrayVersion version = new TArrayVersion(0);
