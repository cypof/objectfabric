 ...
 * type at runtime.
 */
public class TArrayTemplate/* generic_declaration */extends TIndexed implements Iterable<Float> {
    ...
    public TArrayTemplate(Resource resource, int length) {
        super(resource, new TArrayVersionTemplate(length));
     ...
     */
    /* generic start */public TArrayTemplate(Resource resource, int length, TType genericParam) {
        super(resource, new TArrayVersionTemplate(length));
    ...
    public final float get(int index) {
        ...
        TArrayVersionTemplate version = (TArrayVersionTemplate) getVersionN_(inner, index);
        float value = version != null ? (float) version.get(index) : 0 /* Default */;
    ...
    public final void set(int index, float value) {
        ...
        TArrayVersionTemplate version = (TArrayVersionTemplate) getOrCreateVersion_(inner);
    ...
    protected final TObject.Version createVersion_() {
        TArrayVersionTemplate version = new TArrayVersionTemplate(0);
