...
class TArrayVersionTemplate extends TIndexed.VersionN {

    // .NETstatic readonly bool IS_TOBJECT = ObjectFabric.TType.IsTObject(typeof(T));

    private float[][] _values;

    TArrayVersionTemplate(int length) {
        super(length);
    ...
    TObject.Version merge(TObject.Version target, TObject.Version next, boolean threadPrivate) {
        ...
        TArrayVersionTemplate merged = (TArrayVersionTemplate) super.merge(target, next, threadPrivate);
    ...
    void deepCopy(TObject.Version source_) {
        TArrayVersionTemplate source = (TArrayVersionTemplate) source_;
    ...
    // TODO simplify
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionTemplate source, boolean deep) {
