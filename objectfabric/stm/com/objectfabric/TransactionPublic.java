...
abstract class TransactionPublic extends TransactionPrivate {
    ...
    private static final AtomicReferenceFieldUpdater<TransactionPublic, Snapshot> _sharedSnapshotUpdater;
    ...
    static {
        _sharedSnapshotUpdater = AtomicReferenceFieldUpdater.newUpdater(TransactionPublic.class, Snapshot.class, "_sharedSnapshot");
    }
    ...
    final boolean casSharedSnapshot(Snapshot expected, Snapshot update) {
        ...
        return _sharedSnapshotUpdater.compareAndSet(this, expected, update);
    }
