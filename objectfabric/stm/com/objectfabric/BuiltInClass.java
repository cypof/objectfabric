...
final class BuiltInClass {
    ...
    static {
        ...
        all.add(TRANSACTION = new BuiltInClass(DefaultObjectModelBase.COM_OBJECTFABRIC_TRANSACTION_CLASS_ID, "com.objectfabric.Transaction"));

        for (int i = 0; i < DefaultObjectModelBase.METHOD_COUNT; i++)
            all.add(new BuiltInClass(DefaultObjectModelBase.CLASS_COUNT + i, "com.objectfabric.DefaultObjectModelBase.Method" + i));

        all.add(TOBJECT = new BuiltInClass(DefaultObjectModel.COM_OBJECTFABRIC_TOBJECT_CLASS_ID, "com.objectfabric.TObject.UserTObject"));
        all.add(OBJECT_MODEL = new BuiltInClass(DefaultObjectModel.COM_OBJECTFABRIC_OBJECT_MODEL_CLASS_ID, "com.objectfabric.ObjectModel"));
        all.add(TLIST = new BuiltInClass(DefaultObjectModel.COM_OBJECTFABRIC_TLIST_CLASS_ID, "com.objectfabric.TList"));
        all.add(TMAP = new BuiltInClass(DefaultObjectModel.COM_OBJECTFABRIC_TMAP_CLASS_ID, "com.objectfabric.TMap"));
        all.add(TSET = new BuiltInClass(DefaultObjectModel.COM_OBJECTFABRIC_TSET_CLASS_ID, "com.objectfabric.TSet"));
