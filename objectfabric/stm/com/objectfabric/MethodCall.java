...
public abstract class MethodCall extends FutureWithCallback {
    ...
    private static final AtomicReferenceFieldUpdater<MethodCall, Future> _userFutureUpdater;

    private TObject.Version[] _callbackWrites;

    static {
        _userFutureUpdater = AtomicReferenceFieldUpdater.newUpdater(MethodCall.class, Future.class, "_userFuture");
    }
