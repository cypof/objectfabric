...
public class TArrayByte extends TIndexed implements Iterable<Byte> {
    ...
    public static final TType TYPE = new TType(DefaultObjectModel.getInstance(), -1, new TType(ImmutableClass.BYTE));
    ...
    public TArrayByte(int length) {
        this(Transaction.getDefaultTrunk(), length);
    }

    public TArrayByte(Transaction trunk, int length) {
        super(new TArrayVersionByte(null, length), trunk);
     ...
     */
    /* generic start public TArrayByte(Transaction trunk, int length, TType genericParam) {
        this(trunk, length);
        ...
        if (genericParam != null) {
            ...
            ((TArrayVersionByte) getSharedVersion_objectfabric())._genericParameters = new TType[] { genericParam };
        }
    } generic end */
    ...
    public final byte get(int index) {
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionByte version = (TArrayVersionByte) getTIndexedNVersion_objectfabric(inner, index);
    ...
    public final byte getPrevious(int index) {
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionByte version = (TArrayVersionByte) findTIndexedNPublicVersion(inner, index);
            value = version != null ? (byte) version.get(index) : ((byte) 0);
        }
    ...
    public final void set(int index, byte value) {
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionByte version = (TArrayVersionByte) getOrCreateVersion_objectfabric(inner);
            version.setBit(index);
            version.set(index, value);
        }
