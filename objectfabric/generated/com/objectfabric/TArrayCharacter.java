...
public class TArrayCharacter extends TIndexed implements Iterable<Character> {
    ...
    public static final TType TYPE = new TType(DefaultObjectModel.getInstance(), -1, new TType(ImmutableClass.CHARACTER));
    ...
    public TArrayCharacter(int length) {
        this(Transaction.getDefaultTrunk(), length);
    }

    public TArrayCharacter(Transaction trunk, int length) {
        super(new TArrayVersionCharacter(null, length), trunk);
     ...
     */
    /* generic start public TArrayCharacter(Transaction trunk, int length, TType genericParam) {
        this(trunk, length);
        ...
        if (genericParam != null) {
            ...
            ((TArrayVersionCharacter) getSharedVersion_objectfabric())._genericParameters = new TType[] { genericParam };
        }
    } generic end */
    ...
    public final char get(int index) {
        ...
        if (IS_TOBJECT) {
            ...
            value = (Character) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else if (CAN_BE_TOBJECT) {
            TArrayVersion version = (TArrayVersion ) getTIndexedNVersion_objectfabric(inner, index);
            value = (Character) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else {
            TArrayVersionCharacter version = (TArrayVersionCharacter) getTIndexedNVersion_objectfabric(inner, index);
            value = version != null ? (char) version.get(index) : '\0';
        }
     ...
     */
    @SuppressWarnings("cast")
    public final char getPrevious(int index) {
        if (index < 0 || index >= length())
            throw new IndexOutOfBoundsException();
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionCharacter version = (TArrayVersionCharacter) findTIndexedNPublicVersion(inner, index);
            value = version != null ? (char) version.get(index) : '\0';
        }
    ...
    public final void set(int index, char value) {
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionCharacter version = (TArrayVersionCharacter) getOrCreateVersion_objectfabric(inner);
            version.setBit(index);
            version.set(index, value);
        }
