...
import org.objectfabric.TArrayBoolean;
...
@Export("TArrayBoolean")
@ExportPackage("of")
public class JSArrayBoolean implements Exportable {

    // TODO back with JS typed arrays?
    public static final class ArrayInternal extends TArrayBoolean implements Internal {
    ...
    public JSArrayBoolean(JSResource resource, int length) {
        _internal = new ArrayInternal(resource.internal(), length);
    }

    @NoExport
    public JSArrayBoolean() {
    }
