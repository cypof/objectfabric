...
import org.objectfabric.TArrayCharacter;
...
@Export("TArrayCharacter")
@ExportPackage("of")
public class JSArrayCharacter implements Exportable {

    // TODO back with JS typed arrays?
    public static final class ArrayInternal extends TArrayCharacter implements Internal {

        JSArrayCharacter _js;
    ...
    public JSArrayCharacter(JSResource resource, int length) {
        _internal = new ArrayInternal(resource.internal(), length);
    }

    @NoExport
    public JSArrayCharacter() {
    }
