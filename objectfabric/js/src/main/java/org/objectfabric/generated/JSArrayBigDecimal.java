...
import org.objectfabric.TArrayBigDecimal;
...
@Export("TArrayBigDecimal")
@ExportPackage("of")
public class JSArrayBigDecimal implements Exportable {

    // TODO back with JS typed arrays?
    public static final class ArrayInternal extends TArrayBigDecimal implements Internal {

        JSArrayBigDecimal _js;
    ...
    public JSArrayBigDecimal(JSResource resource, int length) {
        _internal = new ArrayInternal(resource.internal(), length);
    }

    @NoExport
    public JSArrayBigDecimal() {
    }

    public java.math.BigDecimal get(int index) {
