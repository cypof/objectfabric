...
public class Door extends of4gwt.TGeneratedFields32 {

    public Door() {
        this(of4gwt.Transaction.getDefaultTrunk());
    }

    public Door(of4gwt.Transaction trunk) {
        this(new Version(null, FIELD_COUNT), trunk);
    }

    protected Door(of4gwt.TObject.Version shared, of4gwt.Transaction trunk) {
        super(shared, trunk);
    }

    public static final of4gwt.TType TYPE = new of4gwt.TType(objectmodel.client.generated.MyObjectModel.getInstance(), objectmodel.client.generated.MyObjectModel.OBJECTMODEL_CLIENT_GENERATED_DOOR_CLASS_ID);
     ...
     */
    public final of4gwt.misc.Future<java.lang.Void> openWindowAsync(int height, com.google.gwt.user.client.rpc.AsyncCallback<java.lang.Void> callback) {
     ...
     */
    public final of4gwt.misc.Future<java.lang.Void> openWindowAsync(int height, com.google.gwt.user.client.rpc.AsyncCallback<java.lang.Void> callback, of4gwt.AsyncOptions asyncOptions) {
    ...
    public final of4gwt.misc.Future<java.lang.Void> openWindowAsync(int height, com.google.gwt.user.client.rpc.AsyncCallback<java.lang.Void> callback, of4gwt.AsyncOptions asyncOptions, of4gwt.misc.Executor executor) {
        if (executor == of4gwt.misc.TransparentExecutor.getInstance()) {
            ...
            if (height != 0) {
                ...
                version_.setBit(objectmodel.client.generated.MyObjectModel.Method2.HEIGHT_INDEX);
            }

            of4gwt.TObject.UserTObject.LocalMethodCall call_ = new of4gwt.TObject.UserTObject.LocalMethodCall(this, objectmodel.client.generated.MyObjectModel.Method2.INSTANCE, version_, METHOD_0, callback, asyncOptions);
     ...
     */
    protected void openWindowImplementationAsync(int height, of4gwt.MethodCall call) {
        try {
            openWindowImplementation(height);
            call.set(null);
        } catch (java.lang.Exception e_) {
    ...
    protected void invoke_objectfabric(of4gwt.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                objectmodel.client.generated.MyObjectModel.Method2.Version version_ = (objectmodel.client.generated.MyObjectModel.Method2.Version) getMethodVersion_objectfabric(call);
    ...
    protected void setError_objectfabric(of4gwt.TObject.Version version, int index, java.lang.String error) {
        switch (index) {
            case METHOD_0: {
                ((objectmodel.client.generated.MyObjectModel.Method2.Version) version)._error_objectfabric = error;
                ((objectmodel.client.generated.MyObjectModel.Method2.Version) version).setBit(objectmodel.client.generated.MyObjectModel.Method2.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            default: {
    ...
    protected void getResultOrError_objectfabric(of4gwt.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                objectmodel.client.generated.MyObjectModel.Method2.Version version = (objectmodel.client.generated.MyObjectModel.Method2.Version) getMethodVersion_objectfabric(call);
    ...
    protected static class Version extends of4gwt.TGeneratedFields32.Version {
        ...
        public int getClassId() {
            return objectmodel.client.generated.MyObjectModel.OBJECTMODEL_CLIENT_GENERATED_DOOR_CLASS_ID;
        }
