...
public class ImagesObjectModel extends com.objectfabric.ObjectModel {
    ...
    public static final int COM_OBJECTFABRIC_EXAMPLES_ANDROID_GENERATED_IMAGEINFO_CLASS_ID = 0;
    ...
    protected java.lang.Class getClass(int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case COM_OBJECTFABRIC_EXAMPLES_ANDROID_GENERATED_IMAGEINFO_CLASS_ID:
                return com.objectfabric.examples.android.generated.ImageInfo.class;
        }
    ...
    protected com.objectfabric.TObject.UserTObject createInstance(com.objectfabric.Transaction trunk, int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case COM_OBJECTFABRIC_EXAMPLES_ANDROID_GENERATED_IMAGEINFO_CLASS_ID:
                return new com.objectfabric.examples.android.generated.ImageInfo(trunk);
        }
