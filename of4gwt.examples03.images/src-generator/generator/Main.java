...
public class Main {
    ...
    /**
     * This generates the same set of files as the Java version of the Images demo, but
     * compatible with GWT.
     */
    public static void main(String[] args) throws Exception {
        ObjectModelDef model = part09.images.generator.Main.create();
         ...
         */
        byte[] uid = part09.images.generated.ImagesObjectModel.getUID();
