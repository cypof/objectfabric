...
public abstract class UsernamePasswordUserManagerBase extends com.objectfabric.TGeneratedFields32 {
    ...
    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(com.objectfabric.ShiroObjectModel.getInstance(), com.objectfabric.ShiroObjectModel.COM_OBJECTFABRIC_USERNAMEPASSWORDUSERMANAGER_CLASS_ID);
    ...
    public final java.util.concurrent.Future<java.lang.Void> createAccountAsync(java.lang.String username, java.lang.String password, java.lang.Object userData, com.objectfabric.misc.AsyncCallback<java.lang.Void> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            com.objectfabric.ShiroObjectModel.Method0.Version version_ = (com.objectfabric.ShiroObjectModel.Method0.Version) createVersion_objectfabric(com.objectfabric.ShiroObjectModel.Method0.INSTANCE);

            if (username != null) {
                version_._username = username;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method0.USERNAME_INDEX);
            }

            if (password != null) {
                version_._password = password;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method0.PASSWORD_INDEX);
            }

            if (userData != null) {
                version_._userData = userData;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method0.USER_DATA_INDEX);
            }

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, com.objectfabric.ShiroObjectModel.Method0.INSTANCE, version_, METHOD_0, callback, asyncOptions);
    ...
    public final java.util.concurrent.Future<java.lang.Void> updateAccountAsync(java.lang.String username, java.lang.String oldPassword, java.lang.String newPassword, java.lang.Object userData, com.objectfabric.misc.AsyncCallback<java.lang.Void> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            com.objectfabric.ShiroObjectModel.Method1.Version version_ = (com.objectfabric.ShiroObjectModel.Method1.Version) createVersion_objectfabric(com.objectfabric.ShiroObjectModel.Method1.INSTANCE);

            if (username != null) {
                version_._username = username;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method1.USERNAME_INDEX);
            }

            if (oldPassword != null) {
                version_._oldPassword = oldPassword;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method1.OLD_PASSWORD_INDEX);
            }

            if (newPassword != null) {
                version_._newPassword = newPassword;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method1.NEW_PASSWORD_INDEX);
            }

            if (userData != null) {
                version_._userData = userData;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method1.USER_DATA_INDEX);
            }

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, com.objectfabric.ShiroObjectModel.Method1.INSTANCE, version_, METHOD_1, callback, asyncOptions);
            executor.execute(call_);
            return call_;
        }
    }
    ...
    public final java.util.concurrent.Future<java.lang.Void> deleteAccountAsync(java.lang.String username, com.objectfabric.misc.AsyncCallback<java.lang.Void> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            com.objectfabric.ShiroObjectModel.Method2.Version version_ = (com.objectfabric.ShiroObjectModel.Method2.Version) createVersion_objectfabric(com.objectfabric.ShiroObjectModel.Method2.INSTANCE);

            if (username != null) {
                version_._username = username;
                version_.setBit(com.objectfabric.ShiroObjectModel.Method2.USERNAME_INDEX);
            }

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, com.objectfabric.ShiroObjectModel.Method2.INSTANCE, version_, METHOD_2, callback, asyncOptions);
            executor.execute(call_);
            return call_;
        }
    }
    ...
    protected void invoke_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                com.objectfabric.ShiroObjectModel.Method0.Version version_ = (com.objectfabric.ShiroObjectModel.Method0.Version) getMethodVersion_objectfabric(call);
            ...
            case METHOD_1: {
                com.objectfabric.ShiroObjectModel.Method1.Version version_ = (com.objectfabric.ShiroObjectModel.Method1.Version) getMethodVersion_objectfabric(call);
                java.lang.String username = version_ != null ? (java.lang.String) version_._username : null;
            ...
            case METHOD_2: {
                com.objectfabric.ShiroObjectModel.Method2.Version version_ = (com.objectfabric.ShiroObjectModel.Method2.Version) getMethodVersion_objectfabric(call);
                java.lang.String username = version_ != null ? (java.lang.String) version_._username : null;
    ...
    protected void setError_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.String error) {
        switch (index) {
            case METHOD_0: {
                ((com.objectfabric.ShiroObjectModel.Method0.Version) version)._error_objectfabric = error;
                ((com.objectfabric.ShiroObjectModel.Method0.Version) version).setBit(com.objectfabric.ShiroObjectModel.Method0.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            case METHOD_1: {
                ((com.objectfabric.ShiroObjectModel.Method1.Version) version)._error_objectfabric = error;
                ((com.objectfabric.ShiroObjectModel.Method1.Version) version).setBit(com.objectfabric.ShiroObjectModel.Method1.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            case METHOD_2: {
                ((com.objectfabric.ShiroObjectModel.Method2.Version) version)._error_objectfabric = error;
                ((com.objectfabric.ShiroObjectModel.Method2.Version) version).setBit(com.objectfabric.ShiroObjectModel.Method2.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            default: {
    ...
    protected void getResultOrError_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                com.objectfabric.ShiroObjectModel.Method0.Version version = (com.objectfabric.ShiroObjectModel.Method0.Version) getMethodVersion_objectfabric(call);
            ...
            case METHOD_1: {
                com.objectfabric.ShiroObjectModel.Method1.Version version = (com.objectfabric.ShiroObjectModel.Method1.Version) getMethodVersion_objectfabric(call);
            ...
            case METHOD_2: {
                com.objectfabric.ShiroObjectModel.Method2.Version version = (com.objectfabric.ShiroObjectModel.Method2.Version) getMethodVersion_objectfabric(call);
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public int getClassId() {
            return com.objectfabric.ShiroObjectModel.COM_OBJECTFABRIC_USERNAMEPASSWORDUSERMANAGER_CLASS_ID;
        }
