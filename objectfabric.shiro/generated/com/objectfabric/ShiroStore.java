...
public class ShiroStore extends com.objectfabric.TGeneratedFields32 {
    ...
    public ShiroStore(com.objectfabric.Transaction trunk) {
        this(trunk, new com.objectfabric.LazyMap<java.lang.String, com.objectfabric.Account>(trunk), new com.objectfabric.LazyMap<java.lang.String, java.lang.Object>(trunk));
    }

    public ShiroStore(com.objectfabric.LazyMap<java.lang.String, com.objectfabric.Account> accounts, com.objectfabric.LazyMap<java.lang.String, java.lang.Object> sessions) {
        this(com.objectfabric.Transaction.getDefaultTrunk(), accounts, sessions);
    }

    public ShiroStore(com.objectfabric.Transaction trunk, com.objectfabric.LazyMap<java.lang.String, com.objectfabric.Account> accounts, com.objectfabric.LazyMap<java.lang.String, java.lang.Object> sessions) {
        this(new Version(null, FIELD_COUNT), trunk, accounts, sessions);
    }

    protected ShiroStore(com.objectfabric.TObject.Version shared, com.objectfabric.Transaction trunk, com.objectfabric.LazyMap<java.lang.String, com.objectfabric.Account> accounts, com.objectfabric.LazyMap<java.lang.String, java.lang.Object> sessions) {
        super(shared, trunk);
    ...
    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(com.objectfabric.ShiroObjectModel.getInstance(), com.objectfabric.ShiroObjectModel.COM_OBJECTFABRIC_SHIROSTORE_CLASS_ID);

    public final com.objectfabric.LazyMap<java.lang.String, com.objectfabric.Account> getAccounts() {
        Version v = (Version) getSharedVersion_objectfabric();
        return (com.objectfabric.LazyMap<java.lang.String, com.objectfabric.Account>) getUserTObject_objectfabric(v._accounts);
    }
    ...
    public static final com.objectfabric.TType ACCOUNTS_TYPE = com.objectfabric.LazyMap.TYPE;

    public static final int SESSIONS_INDEX = 1;

    public static final java.lang.String SESSIONS_NAME = "sessions";

    public static final com.objectfabric.TType SESSIONS_TYPE = com.objectfabric.LazyMap.TYPE;
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public int getClassId() {
            return com.objectfabric.ShiroObjectModel.COM_OBJECTFABRIC_SHIROSTORE_CLASS_ID;
        }
