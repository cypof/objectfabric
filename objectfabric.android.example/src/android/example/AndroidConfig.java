...
/**
 * Configures ObjectFabric for an Android application. This configuration automatically
 * commits changes performed by the UI thread (C.f. createAutoCommitPolicy()) and executes
