...
public class Market extends com.objectfabric.TGeneratedFields32 {
    ...
    public Market(com.objectfabric.Transaction trunk) {
        this(trunk, new com.objectfabric.TSet<finance.generated.User>(trunk));
    }

    public Market(com.objectfabric.TSet<finance.generated.User> Users) {
        this(com.objectfabric.Transaction.getDefaultTrunk(), Users);
    }

    public Market(com.objectfabric.Transaction trunk, com.objectfabric.TSet<finance.generated.User> Users) {
        this(new Version(null, FIELD_COUNT), trunk, Users);
    }

    protected Market(com.objectfabric.TObject.Version shared, com.objectfabric.Transaction trunk, com.objectfabric.TSet<finance.generated.User> Users) {
        super(shared, trunk);
    ...
    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(finance.generated.ObjectModel.getInstance(), finance.generated.ObjectModel.FINANCE_GENERATED_MARKET_CLASS_ID);

    public final com.objectfabric.TSet<finance.generated.User> getUsers() {
        Version v = (Version) getSharedVersion_objectfabric();
        return (com.objectfabric.TSet<finance.generated.User>) getUserTObject_objectfabric(v._Users);
    }
    ...
    public static final com.objectfabric.TType USERS_TYPE = com.objectfabric.TSet.TYPE;
     ...
     * 
     */
    public final com.objectfabric.TList<finance.generated.Instrument> getInstruments(java.lang.String query) {
     ...
     */
    public final com.objectfabric.TList<finance.generated.Instrument> getInstruments(java.lang.String query, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance())
            return getInstrumentsImplementation(query);
        else {
            java.util.concurrent.Future<com.objectfabric.TList<finance.generated.Instrument>> future_ = getInstrumentsAsync(query, getNopCallback_objectfabric(), null, executor);
     ...
     */
    public final java.util.concurrent.Future<com.objectfabric.TList<finance.generated.Instrument>> getInstrumentsAsync(java.lang.String query, com.objectfabric.misc.AsyncCallback<com.objectfabric.TList<finance.generated.Instrument>> callback) {
     ...
     */
    public final java.util.concurrent.Future<com.objectfabric.TList<finance.generated.Instrument>> getInstrumentsAsync(java.lang.String query, com.objectfabric.misc.AsyncCallback<com.objectfabric.TList<finance.generated.Instrument>> callback, com.objectfabric.AsyncOptions asyncOptions) {
     ...
     */
    public final java.util.concurrent.Future<com.objectfabric.TList<finance.generated.Instrument>> getInstrumentsAsync(java.lang.String query, com.objectfabric.misc.AsyncCallback<com.objectfabric.TList<finance.generated.Instrument>> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            com.objectfabric.TList<finance.generated.Instrument> result_ = null;
            ...
            finance.generated.ObjectModel.Method0.Version version_ = (finance.generated.ObjectModel.Method0.Version) createVersion_objectfabric(finance.generated.ObjectModel.Method0.INSTANCE);

            if (query != null) {
                version_._query = query;
                version_.setBit(finance.generated.ObjectModel.Method0.QUERY_INDEX);
            }

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, finance.generated.ObjectModel.Method0.INSTANCE, version_, METHOD_0, callback, asyncOptions);
     ...
     */
    protected com.objectfabric.TList<finance.generated.Instrument> getInstrumentsImplementation(java.lang.String query) {
    ...
    protected void invoke_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                finance.generated.ObjectModel.Method0.Version version_ = (finance.generated.ObjectModel.Method0.Version) getMethodVersion_objectfabric(call);
    ...
    protected void setResult_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.Object result) {
        switch (index) {
            case METHOD_0: {
                ((finance.generated.ObjectModel.Method0.Version) version)._return_objectfabric = (com.objectfabric.TList<finance.generated.Instrument>) result;
                ((finance.generated.ObjectModel.Method0.Version) version).setBit(finance.generated.ObjectModel.Method0.RETURN_OBJECTFABRIC_INDEX);
                break;
            }
            default: {
    ...
    protected void setError_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.String error) {
        switch (index) {
            case METHOD_0: {
                ((finance.generated.ObjectModel.Method0.Version) version)._error_objectfabric = error;
                ((finance.generated.ObjectModel.Method0.Version) version).setBit(finance.generated.ObjectModel.Method0.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            default: {
    ...
    protected void getResultOrError_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                finance.generated.ObjectModel.Method0.Version version = (finance.generated.ObjectModel.Method0.Version) getMethodVersion_objectfabric(call);
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public int getClassId() {
            return finance.generated.ObjectModel.FINANCE_GENERATED_MARKET_CLASS_ID;
        }
