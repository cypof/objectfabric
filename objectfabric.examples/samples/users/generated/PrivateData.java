...
public class PrivateData extends com.objectfabric.TGeneratedFields32 {

    public PrivateData() {
        this(com.objectfabric.Transaction.getDefaultTrunk());
    }

    public PrivateData(com.objectfabric.Transaction trunk) {
        this(new Version(null, FIELD_COUNT), trunk);
    }

    protected PrivateData(com.objectfabric.TObject.Version shared, com.objectfabric.Transaction trunk) {
        super(shared, trunk);
    }

    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(users.generated.ObjectModel.getInstance(), users.generated.ObjectModel.USERS_GENERATED_PRIVATEDATA_CLASS_ID);
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public com.objectfabric.TObject.Version merge(com.objectfabric.TObject.Version target, com.objectfabric.TObject.Version next, int flags) {
            PrivateData.Version source = (PrivateData.Version) next;
            PrivateData.Version merged = (PrivateData.Version) super.merge(target, next, flags);
        ...
        public com.objectfabric.TObject.Version createVersion() {
            return new PrivateData.Version(this, FIELD_COUNT);
        }

        @Override
        public int getClassId() {
            return users.generated.ObjectModel.USERS_GENERATED_PRIVATEDATA_CLASS_ID;
        }
