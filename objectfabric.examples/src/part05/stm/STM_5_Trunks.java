...
import part05.stm.generated.SimpleObjectModel;
...
public class STM_5_Trunks {
    ...
    public Store run() throws IOException {
         ...
         */
        PlatformFile.mkdir(part04.store.Main.TEMP_FOLDER);
        PlatformFile.deleteFileIfExists(part04.store.Main.TEMP_FILE);
        PlatformFile.deleteFileIfExists(part04.store.Main.TEMP_FILE + FileStore.LOG_EXTENSION);
        final FileStore store = new FileStore(part04.store.Main.TEMP_FILE);
