...
public class SimpleObjectModel extends com.objectfabric.ObjectModel {
    ...
    private static final byte[] UID = { 94, 106, 39, -113, 60, -13, 31, 47, -90, -44, 91, -81, -57, -121, -9, -65 };
    ...
    public static final int PART05_STM_GENERATED_SIMPLECLASS_CLASS_ID = 0;
    ...
    protected java.lang.Class getClass(int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART05_STM_GENERATED_SIMPLECLASS_CLASS_ID:
                return part05.stm.generated.SimpleClass.class;
        }
    ...
    protected com.objectfabric.TObject.UserTObject createInstance(com.objectfabric.Transaction trunk, int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART05_STM_GENERATED_SIMPLECLASS_CLASS_ID:
                return new part05.stm.generated.SimpleClass(trunk);
        }
