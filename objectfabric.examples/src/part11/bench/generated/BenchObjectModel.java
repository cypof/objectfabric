...
public class BenchObjectModel extends com.objectfabric.ObjectModel {
    ...
    private static final byte[] UID = { -111, -23, 93, -70, 123, 27, -48, 113, 41, -116, -126, -111, -96, -37, 38, 41 };

    private static volatile BenchObjectModel _instance;

    private static final Object _lock = new Object();

    protected BenchObjectModel(com.objectfabric.TObject.Version shared) {
        super(shared);
    }

    protected BenchObjectModel() {
        this(new Version(null));
    }

    public static BenchObjectModel getInstance() {
        if (_instance == null) {
            synchronized (_lock) {
                if (_instance == null)
                    _instance = new BenchObjectModel();
            }
        }
     ...
     */
    public static void registerOverridenModel(BenchObjectModel model) {
        synchronized (_lock) {
            if (_instance != null)
    ...
    public static final int PART11_BENCH_GENERATED_MYCLASS_CLASS_ID = 0;
    ...
    protected java.lang.Class getClass(int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART11_BENCH_GENERATED_MYCLASS_CLASS_ID:
                return part11.bench.generated.MyClass.class;
        }
    ...
    protected com.objectfabric.TObject.UserTObject createInstance(com.objectfabric.Transaction trunk, int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART11_BENCH_GENERATED_MYCLASS_CLASS_ID:
                return new part11.bench.generated.MyClass(trunk);
        }
