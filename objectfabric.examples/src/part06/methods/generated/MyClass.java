...
public class MyClass extends com.objectfabric.TGeneratedFields32 {
    ...
    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(part06.methods.generated.ObjectModel.getInstance(), part06.methods.generated.ObjectModel.PART06_METHODS_GENERATED_MYCLASS_CLASS_ID);
    ...
    public final java.util.concurrent.Future<java.lang.Integer> startAsync(java.lang.String text, com.objectfabric.misc.AsyncCallback<java.lang.Integer> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            if (text != null) {
                version_._text = text;
                version_.setBit(part06.methods.generated.ObjectModel.Method0.TEXT_INDEX);
            }

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, part06.methods.generated.ObjectModel.Method0.INSTANCE, version_, METHOD_0, callback, asyncOptions);
    ...
    public final java.util.concurrent.Future<java.lang.Void> stopAsync(com.objectfabric.misc.AsyncCallback<java.lang.Void> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, part06.methods.generated.ObjectModel.Method1.INSTANCE, version_, METHOD_1, callback, asyncOptions);
            executor.execute(call_);
            return call_;
        }
    }
    ...
    protected void invoke_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                part06.methods.generated.ObjectModel.Method0.Version version_ = (part06.methods.generated.ObjectModel.Method0.Version) getMethodVersion_objectfabric(call);
    ...
    protected void setResult_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.Object result) {
        switch (index) {
            case METHOD_0: {
                ((part06.methods.generated.ObjectModel.Method0.Version) version)._return_objectfabric = (java.lang.Integer) result;
                ((part06.methods.generated.ObjectModel.Method0.Version) version).setBit(part06.methods.generated.ObjectModel.Method0.RETURN_OBJECTFABRIC_INDEX);
                break;
            }
            case METHOD_1: {
                break;
    ...
    protected void setError_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.String error) {
        switch (index) {
            case METHOD_0: {
                ((part06.methods.generated.ObjectModel.Method0.Version) version)._error_objectfabric = error;
                ((part06.methods.generated.ObjectModel.Method0.Version) version).setBit(part06.methods.generated.ObjectModel.Method0.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            case METHOD_1: {
                ((part06.methods.generated.ObjectModel.Method1.Version) version)._error_objectfabric = error;
                ((part06.methods.generated.ObjectModel.Method1.Version) version).setBit(part06.methods.generated.ObjectModel.Method1.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            default: {
    ...
    protected void getResultOrError_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                part06.methods.generated.ObjectModel.Method0.Version version = (part06.methods.generated.ObjectModel.Method0.Version) getMethodVersion_objectfabric(call);
            ...
            case METHOD_1: {
                part06.methods.generated.ObjectModel.Method1.Version version = (part06.methods.generated.ObjectModel.Method1.Version) getMethodVersion_objectfabric(call);
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public int getClassId() {
            return part06.methods.generated.ObjectModel.PART06_METHODS_GENERATED_MYCLASS_CLASS_ID;
        }
