...
public class ObjectModel extends com.objectfabric.ObjectModel {
    ...
    private static final byte[] UID = { -102, -99, -90, -70, 34, 21, 121, 20, 99, -80, -48, 66, -21, -35, 37, 23 };
    ...
    public static final int PART08_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID = 0;
    ...
    protected java.lang.Class getClass(int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART08_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID:
                return part08.versioning.generated.SimpleClass.class;
        }
    ...
    protected com.objectfabric.TObject.UserTObject createInstance(com.objectfabric.Transaction trunk, int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART08_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID:
                return new part08.versioning.generated.SimpleClass(trunk);
        }
