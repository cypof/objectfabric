...
public class ObjectModel extends com.objectfabric.ObjectModel {
    ...
    private static final byte[] UID = { 54, -14, 76, -33, -100, -29, -77, 86, -108, 88, -32, 5, 110, 45, 62, 74 };
    ...
    /**
     * Registers this object model so that its classes can be serialized by the system.
     */
    ...
    /**
     * Registers an object model which can override <code>createInstance</code> to let the
     * system use your own derived classes. This is necessary e.g. to implement remote
     * methods on transactional objects.
     */
    ...
    public static final int PART6_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID = 0;
    ...
    protected java.lang.Class getClass(int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART6_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID:
                return part08.versioning.generated.v1.SimpleClass.class;
        }
    ...
    protected com.objectfabric.TObject.UserTObject createInstance(com.objectfabric.Transaction trunk, int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART6_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID:
                return new part08.versioning.generated.v1.SimpleClass(trunk);
        }
