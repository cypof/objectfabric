...
public class ObjectModel extends com.objectfabric.ObjectModel {
    ...
    private static final byte[] UID = { -66, 121, -80, -44, -19, -77, 63, 33, -118, -50, -29, -58, -58, -121, 50, -71 };
    ...
    public static final int PART09_VERSIONING_GENERATED_V1_SIMPLECLASS_CLASS_ID = 0;
    ...
    protected java.lang.Class getClass(int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART09_VERSIONING_GENERATED_V1_SIMPLECLASS_CLASS_ID:
                return part09.versioning.generated.v1.SimpleClass.class;
        }
    ...
    protected com.objectfabric.TObject.UserTObject createInstance(com.objectfabric.Transaction trunk, int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART09_VERSIONING_GENERATED_V1_SIMPLECLASS_CLASS_ID:
                return new part09.versioning.generated.v1.SimpleClass(trunk);
        }
