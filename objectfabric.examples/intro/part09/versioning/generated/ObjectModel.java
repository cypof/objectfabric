...
public class ObjectModel extends com.objectfabric.ObjectModel {
    ...
    private static final byte[] UID = { 26, 97, 29, -46, -97, -96, 4, 66, -29, -96, 89, -47, -74, 122, -116, 54 };
    ...
    public static final int PART09_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID = 0;
    ...
    protected java.lang.Class getClass(int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART09_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID:
                return part09.versioning.generated.SimpleClass.class;
        }
    ...
    protected com.objectfabric.TObject.UserTObject createInstance(com.objectfabric.Transaction trunk, int classId, com.objectfabric.TType[] genericParameters) {
        switch (classId) {
            case PART09_VERSIONING_GENERATED_SIMPLECLASS_CLASS_ID:
                return new part09.versioning.generated.SimpleClass(trunk);
        }
