...
public class Car extends com.objectfabric.TGeneratedFields32 {
    ...
    public static final com.objectfabric.TType VALUE1_TYPE = com.objectfabric.ImmutableClass.INTEGER_BOXED.getType();

    public static final int VALUE2_INDEX = 2;

    public static final java.lang.String VALUE2_NAME = "value2";

    public static final com.objectfabric.TType VALUE2_TYPE = com.objectfabric.ImmutableClass.INTEGER.getType();

    public static final int DRIVER_INDEX = 3;

    public static final java.lang.String DRIVER_NAME = "driver";

    public static final com.objectfabric.TType DRIVER_TYPE = part02.objectmodel.generated.Driver.TYPE;

    public static final int BRAND_INDEX = 4;

    public static final java.lang.String BRAND_NAME = "brand";

    public static final com.objectfabric.TType BRAND_TYPE = com.objectfabric.ImmutableClass.STRING.getType();

    public static final int DOORS_INDEX = 5;

    public static final java.lang.String DOORS_NAME = "doors";

    public static final com.objectfabric.TType DOORS_TYPE = com.objectfabric.TSet.TYPE;

    public static final int SETTINGS_INDEX = 6;

    public static final java.lang.String SETTINGS_NAME = "settings";

    public static final com.objectfabric.TType SETTINGS_TYPE = com.objectfabric.TMap.TYPE;

    public static final int LOG_INDEX = 7;

    public static final java.lang.String LOG_NAME = "log";

    public static final com.objectfabric.TType LOG_TYPE = com.objectfabric.TMap.TYPE;

    public static final int TAG_INDEX = 8;

    public static final java.lang.String TAG_NAME = "tag";

    public static final com.objectfabric.TType TAG_TYPE = com.objectfabric.TType.OBJECT;
