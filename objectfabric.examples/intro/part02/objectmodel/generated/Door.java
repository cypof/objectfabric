...
public class Door extends com.objectfabric.TGeneratedFields32 {

    public Door() {
        this(com.objectfabric.Transaction.getDefaultTrunk());
    }

    public Door(com.objectfabric.Transaction trunk) {
        this(new Version(null, FIELD_COUNT), trunk);
    }

    protected Door(com.objectfabric.TObject.Version shared, com.objectfabric.Transaction trunk) {
        super(shared, trunk);
    }

    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(part02.objectmodel.generated.MyObjectModel.getInstance(), part02.objectmodel.generated.MyObjectModel.PART02_OBJECTMODEL_GENERATED_DOOR_CLASS_ID);
     ...
     * 
     */
    public final void openWindow(int height) {
        openWindow(height, getDefaultMethodExecutor_objectfabric());
    }
     ...
     */
    public final void openWindow(int height, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance())
            openWindowImplementation(height);
        else {
            java.util.concurrent.Future<java.lang.Void> future_ = openWindowAsync(height, getNopCallback_objectfabric(), null, executor);
     ...
     */
    public final java.util.concurrent.Future<java.lang.Void> openWindowAsync(int height, com.objectfabric.misc.AsyncCallback<java.lang.Void> callback) {
        return openWindowAsync(height, callback, getDefaultAsyncOptions_objectfabric(), getDefaultMethodExecutor_objectfabric());
    }

    /**
     * Asynchronous version, with options for the callback.
     */
    public final java.util.concurrent.Future<java.lang.Void> openWindowAsync(int height, com.objectfabric.misc.AsyncCallback<java.lang.Void> callback, com.objectfabric.AsyncOptions asyncOptions) {
        return openWindowAsync(height, callback, asyncOptions, getDefaultMethodExecutor_objectfabric());
    }
    ...
    public final java.util.concurrent.Future<java.lang.Void> openWindowAsync(int height, com.objectfabric.misc.AsyncCallback<java.lang.Void> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            if (height != 0) {
                ...
                version_.setBit(part02.objectmodel.generated.MyObjectModel.Method2.HEIGHT_INDEX);
            }

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, part02.objectmodel.generated.MyObjectModel.Method2.INSTANCE, version_, METHOD_0, callback, asyncOptions);
     ...
     */
    protected void openWindowImplementation(int height) {
     ...
     */
    protected void openWindowImplementationAsync(int height, com.objectfabric.MethodCall call) {
        try {
            openWindowImplementation(height);
            call.set(null);
        } catch (java.lang.Exception e_) {
    ...
    protected void invoke_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                part02.objectmodel.generated.MyObjectModel.Method2.Version version_ = (part02.objectmodel.generated.MyObjectModel.Method2.Version) getMethodVersion_objectfabric(call);
    ...
    protected void setError_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.String error) {
        switch (index) {
            case METHOD_0: {
                ((part02.objectmodel.generated.MyObjectModel.Method2.Version) version)._error_objectfabric = error;
                ((part02.objectmodel.generated.MyObjectModel.Method2.Version) version).setBit(part02.objectmodel.generated.MyObjectModel.Method2.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            default: {
    ...
    protected void getResultOrError_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            case METHOD_0: {
                part02.objectmodel.generated.MyObjectModel.Method2.Version version = (part02.objectmodel.generated.MyObjectModel.Method2.Version) getMethodVersion_objectfabric(call);
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public com.objectfabric.TObject.Version merge(com.objectfabric.TObject.Version target, com.objectfabric.TObject.Version next, int flags) {
            Door.Version merged = (Door.Version) super.merge(target, next, flags);
            return merged;
        }
        ...
        public com.objectfabric.TObject.Version createVersion() {
            return new Door.Version(this, FIELD_COUNT);
        }

        @Override
        public int getClassId() {
            return part02.objectmodel.generated.MyObjectModel.PART02_OBJECTMODEL_GENERATED_DOOR_CLASS_ID;
        }
