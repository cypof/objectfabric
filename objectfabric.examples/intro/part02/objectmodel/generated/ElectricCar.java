...
public class ElectricCar extends part02.objectmodel.generated.Car {
    ...
    public static final com.objectfabric.TType BATTERY_TYPE = part02.objectmodel.generated.Battery.TYPE;
    ...
    public static com.objectfabric.TType getFieldTypeStatic(int index) {
        switch (index) {
            case BATTERY_INDEX:
                return BATTERY_TYPE;
            default:
                return part02.objectmodel.generated.Car.getFieldTypeStatic(index);
        }
    }
