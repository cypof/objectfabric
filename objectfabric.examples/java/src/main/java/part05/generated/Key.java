...
public class Key extends org.objectfabric.TGenerated {

    public Key(org.objectfabric.Resource resource) {
        this(resource, new Version(FIELD_COUNT), FIELD_COUNT);
    }

    protected Key(org.objectfabric.Resource resource, org.objectfabric.TObject.Version shared, int length) {
    ...
    public static final org.objectfabric.TType TYPE = new org.objectfabric.TType(part05.generated.MyObjectModel.instance(), part05.generated.MyObjectModel.PART05_GENERATED_KEY_CLASS_ID);
    ...
    protected int classId_() {
        return part05.generated.MyObjectModel.PART05_GENERATED_KEY_CLASS_ID;
    }
