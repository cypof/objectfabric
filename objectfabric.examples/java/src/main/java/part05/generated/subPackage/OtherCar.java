...
package part05.generated.subPackage;
...
public class OtherCar extends org.objectfabric.TGenerated {

    public OtherCar(org.objectfabric.Resource resource) {
        this(resource, new Version(FIELD_COUNT), FIELD_COUNT);
    }

    protected OtherCar(org.objectfabric.Resource resource, org.objectfabric.TObject.Version shared, int length) {
        super(resource, shared, FIELD_COUNT);
    }

    public OtherCar(OtherCar toCopy) {
        this(toCopy.resource());

    }

    public static final org.objectfabric.TType TYPE = new org.objectfabric.TType(part05.generated.MyObjectModel.instance(), part05.generated.MyObjectModel.PART05_GENERATED_SUBPACKAGE_OTHERCAR_CLASS_ID);
    ...
    protected int classId_() {
        return part05.generated.MyObjectModel.PART05_GENERATED_SUBPACKAGE_OTHERCAR_CLASS_ID;
    }
