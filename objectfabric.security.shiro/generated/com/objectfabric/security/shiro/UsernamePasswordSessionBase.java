...
public abstract class UsernamePasswordSessionBase extends com.objectfabric.TGeneratedFields32 {
    ...
    protected UsernamePasswordSessionBase(com.objectfabric.security.shiro.UsernamePasswordUserManager userManager) {
        this(com.objectfabric.Transaction.getDefaultTrunk(), userManager);
    }

    protected UsernamePasswordSessionBase(com.objectfabric.Transaction trunk, com.objectfabric.security.shiro.UsernamePasswordUserManager userManager) {
        this(new Version(null, FIELD_COUNT), trunk, userManager);
    }

    protected UsernamePasswordSessionBase(com.objectfabric.TObject.Version shared, com.objectfabric.Transaction trunk, com.objectfabric.security.shiro.UsernamePasswordUserManager userManager) {
        super(shared, trunk);
    ...
    public static final com.objectfabric.TType TYPE = new com.objectfabric.TType(com.objectfabric.security.shiro.ShiroObjectModel.getInstance(), com.objectfabric.security.shiro.ShiroObjectModel.COM_OBJECTFABRIC_SECURITY_SHIRO_USERNAMEPASSWORDSESSION_CLASS_ID);

    public final com.objectfabric.security.shiro.UsernamePasswordUserManager getUserManager() {
        Version v = (Version) getSharedVersion_objectfabric();
        return (com.objectfabric.security.shiro.UsernamePasswordUserManager) getUserTObject_objectfabric(v._userManager);
    }
    ...
    public static final java.lang.Class USER_MANAGER_CLASS = com.objectfabric.security.shiro.UsernamePasswordUserManager.class;
    ...
    public final java.util.concurrent.Future<java.lang.String> loginAsync(java.lang.String username, java.lang.String password, com.objectfabric.misc.AsyncCallback<java.lang.String> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, com.objectfabric.security.shiro.ShiroObjectModel.Method3.INSTANCE, version_, METHOD_0, callback, asyncOptions);
     ...
     * 
     */
    public final boolean bind(java.lang.String session) {
        return bind(session, getDefaultMethodExecutor_objectfabric());
    }
     ...
     * Specifies the Executor or TaskScheduler that will run the method. For replicated objects, the method runs by default on the site the object has been created, using site's method executor.
     */
    public final boolean bind(java.lang.String session, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance())
            return bindImplementation(session);
        else {
            java.util.concurrent.Future<java.lang.Boolean> future_ = bindAsync(session, getNopCallback_objectfabric(), null, executor);
     ...
     * Asynchronous version.
     */
    public final java.util.concurrent.Future<java.lang.Boolean> bindAsync(java.lang.String session, com.objectfabric.misc.AsyncCallback<java.lang.Boolean> callback) {
     ...
     * Asynchronous version, with options for the callback.
     */
    public final java.util.concurrent.Future<java.lang.Boolean> bindAsync(java.lang.String session, com.objectfabric.misc.AsyncCallback<java.lang.Boolean> callback, com.objectfabric.AsyncOptions asyncOptions) {
     ...
     * the method runs by default on the site the object has been created. @see Site.getMethodExecutor() to specify an execution site.
     */
    public final java.util.concurrent.Future<java.lang.Boolean> bindAsync(java.lang.String session, com.objectfabric.misc.AsyncCallback<java.lang.Boolean> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            boolean result_ = false;
            java.lang.Exception exception_ = null;

            try {
                result_ = bindImplementation(session);
            } catch (java.lang.Exception e_) {
                exception_ = e_;
            }
            ...
            if (session != null) {
                ...
                version_.setBit(com.objectfabric.security.shiro.ShiroObjectModel.Method4.SESSION_INDEX);
            }

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, com.objectfabric.security.shiro.ShiroObjectModel.Method4.INSTANCE, version_, METHOD_1, callback, asyncOptions);
            executor.execute(call_);
            return call_;
        }
    }
     ...
     * Override to implement the method.
     */
    protected boolean bindImplementation(java.lang.String session) {
        throw new RuntimeException(com.objectfabric.Strings.MISSING_METHOD_CALL_IMPLEMENTATION);
    }
    ...
    protected void bindImplementationAsync(java.lang.String session, com.objectfabric.MethodCall call) {
        try {
            call.set(bindImplementation(session));
        } catch (java.lang.Exception e_) {
            call.setException(e_);
        }
    }
    ...
    public final java.util.concurrent.Future<java.lang.Void> logoutAsync(com.objectfabric.misc.AsyncCallback<java.lang.Void> callback, com.objectfabric.AsyncOptions asyncOptions, java.util.concurrent.Executor executor) {
        if (executor == com.objectfabric.misc.TransparentExecutor.getInstance()) {
            ...
            com.objectfabric.security.shiro.ShiroObjectModel.Method5.Version version_ = (com.objectfabric.security.shiro.ShiroObjectModel.Method5.Version) createVersion_objectfabric(com.objectfabric.security.shiro.ShiroObjectModel.Method5.INSTANCE);

            com.objectfabric.TObject.UserTObject.LocalMethodCall call_ = new com.objectfabric.TObject.UserTObject.LocalMethodCall(this, com.objectfabric.security.shiro.ShiroObjectModel.Method5.INSTANCE, version_, METHOD_2, callback, asyncOptions);
            executor.execute(call_);
            return call_;
        }
    }
    ...
    protected void setResult_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.Object result) {
        switch (index) {
            case METHOD_0: {
                ((com.objectfabric.security.shiro.ShiroObjectModel.Method3.Version) version)._return_objectfabric = (java.lang.String) result;
            ...
            case METHOD_1: {
                ((com.objectfabric.security.shiro.ShiroObjectModel.Method4.Version) version)._return_objectfabric = (java.lang.Boolean) result;
                ((com.objectfabric.security.shiro.ShiroObjectModel.Method4.Version) version).setBit(com.objectfabric.security.shiro.ShiroObjectModel.Method4.RETURN_OBJECTFABRIC_INDEX);
                break;
            }
            case METHOD_2: {
                break;
    ...
    protected void setError_objectfabric(com.objectfabric.TObject.Version version, int index, java.lang.String error) {
        switch (index) {
            ...
            case METHOD_2: {
                ((com.objectfabric.security.shiro.ShiroObjectModel.Method5.Version) version)._error_objectfabric = error;
                ((com.objectfabric.security.shiro.ShiroObjectModel.Method5.Version) version).setBit(com.objectfabric.security.shiro.ShiroObjectModel.Method5.ERROR_OBJECTFABRIC_INDEX);
                break;
            }
            default: {
    ...
    protected void getResultOrError_objectfabric(com.objectfabric.MethodCall call) {
        switch (getMethodCallIndex_objectfabric(call)) {
            ...
            case METHOD_2: {
                com.objectfabric.security.shiro.ShiroObjectModel.Method5.Version version = (com.objectfabric.security.shiro.ShiroObjectModel.Method5.Version) getMethodVersion_objectfabric(call);
    ...
    protected static class Version extends com.objectfabric.TGeneratedFields32.Version {
        ...
        public void setAsObject(int index, java.lang.Object value) {
            switch (index) {
                case USER_MANAGER_INDEX:
                    _userManager = (com.objectfabric.security.shiro.UsernamePasswordUserManager) value;
                    break;
                default:
        ...
        public int getClassId() {
            return com.objectfabric.security.shiro.ShiroObjectModel.COM_OBJECTFABRIC_SECURITY_SHIRO_USERNAMEPASSWORDSESSION_CLASS_ID;
        }
