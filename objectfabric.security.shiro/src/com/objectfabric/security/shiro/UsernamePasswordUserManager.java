 ...
 * <nl>
 * This extension uses the Java serializer, and will register it if not already.
...
public class UsernamePasswordUserManager extends UsernamePasswordUserManagerBase {
    ...
    public UsernamePasswordUserManager(ShiroStore store, int hashIterations) {
        ...
        if (OF.getCustomSerializer() == null)
            OF.setCustomSerializer(new JavaSerializer());
        else if (!(OF.getCustomSerializer() instanceof JavaSerializer))
