...
import of4gwt.transports.rpc.RPCService;
 ...
 */
public abstract class PollingServiceImpl extends RemoteServiceServlet implements RPCService {

    private static final String SESSION_ATTRIBUTE = "objectfabric";

    protected abstract PollingSession createSession();
    ...
    public final byte[] connect() {
        ...
        PollingSession of = createSession();
    ...
    public final byte[] call(byte[] data) {
        HttpSession http = getThreadLocalRequest().getSession();
        PollingSession session = (PollingSession) http.getAttribute(SESSION_ATTRIBUTE);
    ...
    public static class PollingSession extends com.objectfabric.transports.polling.PollingServer.PollingSession implements HttpSessionBindingListener {
