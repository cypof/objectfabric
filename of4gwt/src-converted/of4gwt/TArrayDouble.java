...
public class TArrayDouble extends TIndexed implements Iterable<Double> {
    ...
    public static final TType TYPE = new TType(DefaultObjectModel.getInstance(), -1, new TType(ImmutableClass.DOUBLE));
    ...
    public TArrayDouble(int length) {
        this(Transaction.getDefaultTrunk(), length);
    }

    public TArrayDouble(Transaction trunk, int length) {
        super(new TArrayVersionDouble(null, length), trunk);
     ...
     */
    /* generic start public TArrayDouble(Transaction trunk, int length, TType genericParam) {
        this(trunk, length);
        ...
        if (genericParam != null) {
            ...
            ((TArrayVersionDouble) getSharedVersion_objectfabric())._genericParameters = new TType[] { genericParam };
        }
    } generic end */
    ...
    public final double get(int index) {
        ...
        if (IS_TOBJECT) {
            ...
            value = (Double) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else if (CAN_BE_TOBJECT) {
            TArrayVersion version = (TArrayVersion ) getTIndexedNVersion_objectfabric(inner, index);
            value = (Double) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else {
            TArrayVersionDouble version = (TArrayVersionDouble) getTIndexedNVersion_objectfabric(inner, index);
     ...
     */
    @SuppressWarnings("cast")
    public final double getPrevious(int index) {
        if (index < 0 || index >= length())
            throw new IndexOutOfBoundsException();
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionDouble version = (TArrayVersionDouble) findTIndexedNPublicVersion(inner, index);
            value = version != null ? (double) version.get(index) : 0;
        }
    ...
    public final void set(int index, double value) {
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionDouble version = (TArrayVersionDouble) getOrCreateVersion_objectfabric(inner);
            version.setBit(index);
            version.set(index, value);
        }
    ...
    public final java.util.Iterator<Double> iterator() {
        return new IteratorImpl();
    }

    private final class IteratorImpl implements java.util.Iterator<Double> {
