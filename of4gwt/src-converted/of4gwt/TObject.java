...
import of4gwt.TObject.Reference.UserReferenceWithCount;
...
import of4gwt.misc.PlatformWeakReference;
 ...
 * <code>of4gwt.ImmutableClass</code>.
 */
public abstract class TObject {
    ...
    protected static class UserTObject extends TObject {
        ...
        protected static class LocalMethodCall extends MethodCall {
            ...
            @Override
            public final Object get() throws of4gwt.misc.InterruptedException, ExecutionException {
                return ExpectedExceptionThrower.getCallResult(this);
            }

            final Object superDotGet() throws of4gwt.misc.InterruptedException, ExecutionException {
                return super.get();
            }
