 ...
 */
class TArrayVersionBigDecimal extends TIndexedNVersion {

    private java.math.BigDecimal[][] _values;

    private static final TType[] _genericParameters = new TType[] { new TType(ImmutableClass.DECIMAL) };

    private static final boolean CAN_BE_TOBJECT = false;

    public TArrayVersionBigDecimal(TObject.Version shared, int length) {
        super(shared, length);
    ...
    public final void setValues(java.math.BigDecimal[][] value) {
        _values = value;
    }
    ...
    public TObject.Version merge(TObject.Version target, TObject.Version next, int flags) {
        ...
        TArrayVersionBigDecimal merged = (TArrayVersionBigDecimal) super.merge(target, next, flags);
    ...
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionBigDecimal source, int flags) {
    ...
    private final void merge(java.math.BigDecimal[] merged, of4gwt.misc.Bits.Entry writes, java.math.BigDecimal[] source) {
    ...
    public TObject.Version createVersion() {
        return new TArrayVersionBigDecimal(this, length());
    }
            ...
            for (int i = 0; i < getValues().length; i++) {
                if (getValues()[i] != null) {
                    for (int t = 0; t < getValues()[i].length; t++) {
                        java.math.BigDecimal value = getValues()[i][t];
