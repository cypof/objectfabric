...
public class TArrayInteger extends TIndexed implements Iterable<Integer> {
    ...
    public static final TType TYPE = new TType(DefaultObjectModel.getInstance(), -1, new TType(ImmutableClass.INTEGER));
    ...
    public TArrayInteger(int length) {
        this(Transaction.getDefaultTrunk(), length);
    }

    public TArrayInteger(Transaction trunk, int length) {
        super(new TArrayVersionInteger(null, length), trunk);
     ...
     */
    /* generic start public TArrayInteger(Transaction trunk, int length, TType genericParam) {
        this(trunk, length);
        ...
        if (genericParam != null) {
            ...
            ((TArrayVersionInteger) getSharedVersion_objectfabric())._genericParameters = new TType[] { genericParam };
        }
    } generic end */
    ...
    public final int get(int index) {
        ...
        if (IS_TOBJECT) {
            ...
            value = (Integer) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else if (CAN_BE_TOBJECT) {
            TArrayVersion version = (TArrayVersion ) getTIndexedNVersion_objectfabric(inner, index);
            value = (Integer) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else {
            TArrayVersionInteger version = (TArrayVersionInteger) getTIndexedNVersion_objectfabric(inner, index);
     ...
     */
    @SuppressWarnings("cast")
    public final int getPrevious(int index) {
        if (index < 0 || index >= length())
            throw new IndexOutOfBoundsException();
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionInteger version = (TArrayVersionInteger) findTIndexedNPublicVersion(inner, index);
            value = version != null ? (int) version.get(index) : 0;
        }
    ...
    public final void set(int index, int value) {
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionInteger version = (TArrayVersionInteger) getOrCreateVersion_objectfabric(inner);
            version.setBit(index);
            version.set(index, value);
        }
