 ...
 */
class TArrayVersionDouble extends TIndexedNVersion {

    private double[][] _values;

    private static final TType[] _genericParameters = new TType[] { new TType(ImmutableClass.DOUBLE) };

    private static final boolean CAN_BE_TOBJECT = false;

    public TArrayVersionDouble(TObject.Version shared, int length) {
        super(shared, length);

        if (shared == null) {
            // Preallocate (C.f. TIndexedNVersion._writes)
            int arrayLength = getBits().length;
            _values = new double[arrayLength][];
        }
    }
    ...
    public final double get(int index) {
        if (_values != null) {
            ...
            if (foldedIndex >= 0) {
                double[] current = _values[foldedIndex];
        ...
        if (_values != null) {
            ...
            if (_values[folded] == null) {
                if (value != 0) {
                    ...
                    _values[folded] = new double[arrayLength];
                }
            }
    ...
    public TObject.Version merge(TObject.Version target, TObject.Version next, int flags) {
        ...
        TArrayVersionDouble source = (TArrayVersionDouble) next;
        TArrayVersionDouble merged = (TArrayVersionDouble) super.merge(target, next, flags);
    ...
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionDouble source, int flags) {
    ...
    private final void merge(double[] merged, of4gwt.misc.Bits.Entry writes, double[] source) {
    ...
    public TObject.Version createVersion() {
        return new TArrayVersionDouble(this, length());
    }
