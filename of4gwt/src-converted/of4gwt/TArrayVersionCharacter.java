 ...
 */
class TArrayVersionCharacter extends TIndexedNVersion {

    private char[][] _values;

    private static final TType[] _genericParameters = new TType[] { new TType(ImmutableClass.CHARACTER) };

    private static final boolean CAN_BE_TOBJECT = false;

    public TArrayVersionCharacter(TObject.Version shared, int length) {
        super(shared, length);

        if (shared == null) {
            // Preallocate (C.f. TIndexedNVersion._writes)
            int arrayLength = getBits().length;
            _values = new char[arrayLength][];
        }
    }
    ...
    public final void setValues(char[][] value) {
        _values = value;
    }
    ...
    public final char get(int index) {
        if (_values != null) {
            ...
            if (foldedIndex >= 0) {
                char[] current = _values[foldedIndex];
        ...
        if (_values != null) {
            ...
            if (_values[folded] == null) {
                if (value != '\0') {
                    ...
                    _values[folded] = new char[arrayLength];
                }
            }
    ...
    public TObject.Version merge(TObject.Version target, TObject.Version next, int flags) {
        ...
        TArrayVersionCharacter source = (TArrayVersionCharacter) next;
        TArrayVersionCharacter merged = (TArrayVersionCharacter) super.merge(target, next, flags);
    ...
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionCharacter source, int flags) {
    ...
    private final void merge(char[] merged, of4gwt.misc.Bits.Entry writes, char[] source) {
    ...
    public final void writeWrite(Writer writer, int index) {
        ...
        writer.writeCharacter(get(index));
    }
    ...
    public final void readWrite(Reader reader, int index) {
        ...
        set(index, reader.readCharacter());
    }
    ...
    public TObject.Version createVersion() {
        return new TArrayVersionCharacter(this, length());
    }
