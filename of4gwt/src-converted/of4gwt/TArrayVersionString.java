 ...
 */
class TArrayVersionString extends TIndexedNVersion {

    private java.lang.String[][] _values;

    private static final TType[] _genericParameters = new TType[] { new TType(ImmutableClass.STRING) };

    private static final boolean CAN_BE_TOBJECT = false;

    public TArrayVersionString(TObject.Version shared, int length) {
        super(shared, length);

        if (shared == null) {
            // Preallocate (C.f. TIndexedNVersion._writes)
            int arrayLength = getBits().length;
            _values = new java.lang.String[arrayLength][];
        }
    }
    ...
    public final java.lang.String get(int index) {
        if (_values != null) {
            ...
            if (foldedIndex >= 0) {
                java.lang.String[] current = _values[foldedIndex];
        ...
        if (_values != null) {
            ...
            if (_values[folded] == null) {
                if (value != null) {
                    ...
                    _values[folded] = new java.lang.String[arrayLength];
                }
            }
    ...
    public final void setAsObject(int index, Object value) {
        set(index, (java.lang.String) value);
    }

    @Override
    public final void reindexed(of4gwt.misc.Bits.Entry[] old) {
        if (_values != null) {
            java.lang.String[][] oldValues = _values;
            int arrayLength = getBits().length;
            _values = new java.lang.String[arrayLength][];
    ...
    public TObject.Version merge(TObject.Version target, TObject.Version next, int flags) {
        ...
        TArrayVersionString source = (TArrayVersionString) next;
        TArrayVersionString merged = (TArrayVersionString) super.merge(target, next, flags);
    ...
    @SuppressWarnings("cast")
    private final void merge(TArrayVersionString source, int flags) {
    ...
    private final void merge(java.lang.String[] merged, of4gwt.misc.Bits.Entry writes, java.lang.String[] source) {
    ...
    public TObject.Version createVersion() {
        return new TArrayVersionString(this, length());
    }
            ...
            for (int i = 0; i < getValues().length; i++) {
                if (getValues()[i] != null) {
                    for (int t = 0; t < getValues()[i].length; t++) {
                        java.lang.String value = getValues()[i][t];
