...
public class TArrayBigDecimal extends TIndexed implements Iterable<java.math.BigDecimal> {

    @SuppressWarnings("hiding")
    public static final TType TYPE = new TType(DefaultObjectModel.getInstance(), -1, new TType(ImmutableClass.DECIMAL));
    ...
    public TArrayBigDecimal(int length) {
        this(Transaction.getDefaultTrunk(), length);
    }

    public TArrayBigDecimal(Transaction trunk, int length) {
        super(new TArrayVersionBigDecimal(null, length), trunk);
     ...
     */
    /* generic start public TArrayBigDecimal(Transaction trunk, int length, TType genericParam) {
        this(trunk, length);
        ...
        if (genericParam != null) {
            ...
            ((TArrayVersionBigDecimal) getSharedVersion_objectfabric())._genericParameters = new TType[] { genericParam };
        }
    } generic end */
    ...
    public final java.math.BigDecimal get(int index) {
        ...
        if (IS_TOBJECT) {
            ...
            value = (java.math.BigDecimal) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else if (CAN_BE_TOBJECT) {
            TArrayVersion version = (TArrayVersion ) getTIndexedNVersion_objectfabric(inner, index);
            value = (java.math.BigDecimal) getUserTObject_objectfabric(version != null ? version.get(index) : null);
        } else {
            TArrayVersionBigDecimal version = (TArrayVersionBigDecimal) getTIndexedNVersion_objectfabric(inner, index);
     ...
     */
    @SuppressWarnings("cast")
    public final java.math.BigDecimal getPrevious(int index) {
        if (index < 0 || index >= length())
            throw new IndexOutOfBoundsException();
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionBigDecimal version = (TArrayVersionBigDecimal) findTIndexedNPublicVersion(inner, index);
            value = version != null ? (java.math.BigDecimal) version.get(index) : null;
        }
    ...
    public final void set(int index, java.math.BigDecimal value) {
        ...
        if (IS_TOBJECT) {
            ...
            TArrayVersionBigDecimal version = (TArrayVersionBigDecimal) getOrCreateVersion_objectfabric(inner);
            version.setBit(index);
            version.set(index, value);
        }
    ...
    public final java.util.Iterator<java.math.BigDecimal> iterator() {
        return new IteratorImpl();
    }

    private final class IteratorImpl implements java.util.Iterator<java.math.BigDecimal> {
        ...
        public java.math.BigDecimal next() {
            java.math.BigDecimal value = get(_cursor++);
            return value;
        }
